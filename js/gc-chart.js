...
Vue.component('gc-chart', {
  ...
  mounted: function () {
    ...
    try {
      ...
      console.warn("could not change D3 to current locale: " + this.currentLanguage);
      console.warn("fallback to english time format settings..")
      d3.timeFormatDefaultLocale(this.d3locales['en']);
    }
